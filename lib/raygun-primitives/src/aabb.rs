...
mod test {
    ...
    fn aab(x0: f64, y0: f64, z0: f64, x1: f64, y1: f64, z1: f64) -> AxisAlignedBox {
        AxisAlignedBox {
    ...
    fn intersection() {
        ...
        let test_cases = vec![
            (
                "+z",
                Ray::new(point(0.0, 0.0, -4.0), vector(0.0, 0.0, 1.0)),
                Some(3.5),
            ),
            (
                "-z",
            ...
            (
                "+y",
                Ray::new(point(0.0, -6.0, 0.0), vector(0.0, 1.0, 0.0)),
                Some(5.5),
            ),
            (
                "-y",
                Ray::new(point(0.0, 7.0, 0.0), vector(0.0, -1.0, 0.0)),
                Some(6.5),
            ),
            (
                "+x",
                Ray::new(point(-8.0, 0.0, 0.0), vector(1.0, 0.0, 0.0)),
                Some(7.5),
            ),
            (
                "-x",
                Ray::new(point(9.0, 0.0, 0.0), vector(-1.0, 0.0, 0.0)),
                Some(8.5),
            ),
        ];
