...
impl Angle<Degrees> {
    pub fn degrees(self) -> Angle<Degrees> { self }
    pub fn radians(self) -> Angle<Radians> {
        Angle::new(self.get().to_radians())
    }

    pub fn sin(self) -> f64 { self.get().to_radians().sin() }
    pub fn cos(self) -> f64 { self.get().to_radians().cos() }
    pub fn tan(self) -> f64 { self.get().to_radians().tan() }
}
...
impl Angle<Radians> {
    ...
    pub fn radians(self) -> Angle<Radians> { self }

    pub fn sin(self) -> f64 { self.get().sin() }
    pub fn cos(self) -> f64 { self.get().cos() }
...
mod test {
    ...
    fn tan_of_degrees() {
        ...
        let y = degrees(90.0);
        let tan_y = y.tan();
        assert!(tan_y.is_infinite() || tan_y > 1e16,
